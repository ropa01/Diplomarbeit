...
\newcommand{\stdfig}[3]{\begin{figure} \center \input{#1} \caption{#2} \label{#3} \end{figure}}
\newcommand{\stdtab}[3]{\begin{table} \center \input{#1} \caption{#2} \label{#3} \end{table}}
...
\newcommand{\eqml}[1]{\begin{multiline} #1 \end{multiline}}
