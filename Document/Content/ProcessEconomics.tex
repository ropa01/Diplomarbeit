...
stages, an approach similar to the one in \secref{sec:before} still needs to be employed. In contrast to
...
\label{sec:MultiPeriod}
    ...
    given project is shown in \figref{fig:CashFlow}. When the project commences no revenue is generated
