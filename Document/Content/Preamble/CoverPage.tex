...
\begin{minipage}[b]{8.5cm}
	%\begin{picture}(4.15,0)
		\raisebox{-2.2mm}{\includegraphics[height=2cm]{Pictures/Logos/CPSE_Logo.png}}
...
\begin{minipage}[b]{8.5cm}
	\begin{flushleft}
		\raisebox{-2.2mm}{\includegraphics[height=2cm]{Pictures/Logos/AVT_Logo.png}}
		%\textcolor{CPSEBlue}{
		%\textbf{Professor Efstratios Pistikopoulos} \\ Centre for Process Systems Engineering \\ Imperial College London}
	\end{flushleft}
\end{minipage}
...
\begin{minipage}[b]{8.5cm}
	\begin{flushleft}
		\raisebox{-2.2mm}{\includegraphics[height=2cm]{Pictures/Logos/PSE_Logo.png}}
		%\textcolor{CPSEBlue}{
		%\textbf{Professor Efstratios Pistikopoulos} \\ Centre for Process Systems Engineering \\ Imperial College London}
	\end{flushleft}
\end{minipage}
