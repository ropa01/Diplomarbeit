...
\end{figure}
 ...
 \Eqml{eq:col:CompBalance_opt}{
    		\fracdd{m_{ij}}{t} = \left(1 + s_j^V\right) \cdot V_j \cdot y_{i,j} + \left(1 + s_j^L\right)
 ...
 \Eqml{eq:col:EnergyBalance}{
    		\fracdd{H_j}{t} = \left(1 + s_j^V\right) \cdot V_j \cdot h^V_{j} + \left(1 + s_j^L\right)
        ...
        \subsubsection{Hydrodynamic analogy}
            ...
            \paragraph{equations}
                ...
                \Eq{}{
                    ...
                    \epsilon & = \arctan \left(\cos \varphi \cot \frac{\gamma}{2}
                }
                ...
                \Eq{}{
                    ...
                    u_L |_{y = 0} = 0  \qquad u_L |_{y = \delta} = u_G \qquad \fracddpart
                }