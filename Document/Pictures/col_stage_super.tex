\begin{tikzpicture}
    ...
    \draw [arrow] (-4,0.55) -- (-2,0.55) node [pos=0.25, above] {\footnotesize $F_{j}$};
    \draw [arrow] (-4,-0.55) -- (-2,-0.55) node [pos=0.25, above] {\footnotesize $R_{j}$};
% 	\draw [arrow] (-3.5,1.7) -- (-1,1.7) node [pos=0.25, above] {\footnotesize $F^L_{j}$};
 	\draw [arrow] (1,1) -- (1,3) node [pos=0.75, right] {\footnotesize $V_{j}$};
 	\draw [arrow] (1,1.8) -- (3.5,1.8) node [pos=0.75, above] {\footnotesize $S^V_{j}$};
 	\draw [arrow] (-1,-1) -- (-1,-3) node [pos=0.75, left] {\footnotesize $L_{j}$};
 	\draw [arrow] (-1,-1.8) -- (-3.5,-1.8) node [pos=0.75, above] {\footnotesize $S^L_{j}$};
