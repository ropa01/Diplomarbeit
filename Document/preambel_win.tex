\documentclass[12pt,onecolumn,headsepline,numbers=noenddot,bibtotoc,oneside,a4paper,fleqn,BCOR8mm]{scrreprt}
...
%		\xdefinecolor{RWTHBlue}{rgb}{0.0,0.4039,0.6509} 
%		\xdefinecolor{RWTHlightBlue}{rgb}{0.4666,0.6196,0.7882}
...
\usepackage[colorlinks=false, linkcolor=AVTBlue, citecolor=AVTLightGreen, menucolor=black, breaklinks=false, urlcolor=black]{hyperref}
